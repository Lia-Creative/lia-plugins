...
**A machine can hold several versions at once** (per-scope or per-project installs). The script reports all of them and judges on the oldest, since that is the copy most likely to be serving a stale skill.
