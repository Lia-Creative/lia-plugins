...
- **0.1.1 (2026-09-02, LIAB-1206, cold-review round 1)** — the exceptions are named where the absolutes are (§2, §4, §8, §10 agree); the two-theme declaration of semantics is stated, so the hierarchy actually yields the dark Brand Blue; accents marked mode-independent; Storybook's font serving scoped to the DS's own surface; H3 recorded as un-ruled rather than guessed; the section list carries all eleven; the measurement names both copies it was taken on.
