...
- **The technical judgment** — architecture, the final acceptance criteria, build prep, the pickability check, review-and-merge, security → **load `lead-engineer`** (which routes across its bench).
