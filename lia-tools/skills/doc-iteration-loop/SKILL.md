...
0. **Ground.** Read `execution-discipline/SKILL.md` (mandatory for any skill run). Pull the epic and all children live from Linear, with relations. Never run from a stale execution order.
