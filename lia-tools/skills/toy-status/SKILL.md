...
**Load `_meta/skills/execution-discipline/SKILL.md` first.** Never invent a Linear status, a version, or a stage. If a source is unreachable, say "unreadable from here" for that column — an honest gap beats a guess.
