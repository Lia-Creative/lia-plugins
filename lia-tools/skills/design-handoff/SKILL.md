...
- The engineering lead's `build-prep` cites the artefact's path and its state class; `ready-review`/`ticket-review` treat a design-led story without its artefact as not ready.
