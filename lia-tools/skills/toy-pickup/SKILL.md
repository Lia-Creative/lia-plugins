...
2. **Scope to the work.** For a specific toy (or the toolbox): its `README.md`, then the ACTIVE handover in `00 handover/` (the one without a superseded banner), then the last 2–3 entries of `00 handover/retro-log.md`.
