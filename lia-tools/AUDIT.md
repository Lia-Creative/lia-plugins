...
| PR #53 (**2 Sep**, LIAB-1206, Dan's session) | `design-system` — read from `Products/Design System/using-the-lia-design-system.md`, `Context/brand-v4-reference.md`, the DS repo's `CLAUDE.md` at `798c2615`, and two of Dan's standing type rules the vault guide never carried; nothing superseded, no competing copy. |
